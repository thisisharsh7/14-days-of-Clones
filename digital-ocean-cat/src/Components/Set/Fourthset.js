...
export default function Fourthset() {
  ...
  return (
    <section className="pb-10 pt-40 w-full bg-[url('https://www.digitalocean.com/_next/static/media/bottomWaveSliceBlue5.47e176fb.svg')] bg-repeat-x bg-top">
      <div className=" flex items-center xl:justify-between justify-center max-w-screen-xl mx-auto px-5 gap-16 flex-wrap">
        <div className="flex flex-col md:items-start gap-10 items-center  ">
