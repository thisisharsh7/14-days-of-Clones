    ...
    <>
      ...
      <main className="sign w-full grid place-items-center mt-5 p-1 pb-8">
        <div className="sign-box border w-11/12 sm:w-fit border-black border-opacity-50 px-4 pt-3 pb-5">
          ...
          <form className="flex flex-col w-full sm:w-80 gap-4 mb-5">
            <div className="flex flex-col">
              ...
              <input
                id="email"
                type="email"
                className="border-2 border-gray-900 h-8 p-2 focus:outline-orange-700"
              />
            </div>
            <div className="flex flex-col">
            ...
            <button
              type="button"
              className=" border border-black bg-srchC w-full h-10 mt-2.5 hover:bg-orange-300"
              onClick={signedIn}
            >
              Sign In
            </button>
            <div>
              <p className="text-gray-800 text-sm">
                By Sign In, you agree to amazon terms and condition.Please see
          ...
          <button
            type="button"
            className="border border-black h-12 bg-zinc-300 w-full"
            disabled
          >
